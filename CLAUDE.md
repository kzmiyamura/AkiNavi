...
- **Mail/Job**: Brevo (Email API, `@getbrevo/brevo`) / GitHub Actions (Cron)
...
| 承認アクション | ロール選択（admin / developer / user）して承認 / 拒否。Brevo でユーザーへ通知メール送信 |
...
| Day 14 | 管理者への承認依頼メール通知（Brevo）の設定 | ✅ |
